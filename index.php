...
<div class="logo"><img src="img/LOGO.png" alt="" width="100%"></div>
  <div id="nvai">
    <ul id="nav">
      ...
      <li><a href="frame/news.php"><span>报道</span><span class="engdh">Report</span></a></li>
      <li><a href="frame/public.php"><span>公益榜</span><span class="engdh">Public</span></a></li>  
      <li><a href="frame/contact.php"><span>联系捐助</span><span class="engdh">Contact</span></a></li>
      <li><a href="frame/about.php"><span>关于我们</span><span class="engdh">About us</span></a></li>
    </ul>
  ...
  <div class="cd-user-modal">
    <div class="cd-user-modal-container">
      ...
      <div id="cd-login"> <!-- 登录表单 -->
        <form class="cd-form" action="frame/login.php" method="post">
          <p class="fieldset">
      ...
      <div id="cd-signup"> <!-- 注册表单 -->
        <form class="cd-form" action="frame/reg.php" method="POST">
          <p class="fieldset">
...
<div id="main2"> <span>
  ...
  欢迎您！<br>
  <a href="frame/logoutindex.php">注销</a></div>
<?php }?>
...
<div class="section section5">
  ...
  <div class="bg52"><a href="frame/contact.php" class="bottom"><img src="img/bg52.png" width="100%" alt=""> </a></div>
